...
public class PacketManager implements IPacketHandler
{
	...
	public void onPacketData(INetworkManager manager, Packet250CustomPayload packet, Player player)
	{
		...
		try {
			...
			{
				RecipearLogger.info("[CLIENT] Received update");
				BannedRecipes.setBannedRecipes((ArrayList<BannedRecipe>) inputStream.readObject());
				Recipear.recipeEvents.trigger(new RecipearEvent(Side.CLIENT, true));
			}
